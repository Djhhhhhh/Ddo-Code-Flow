'use strict';
// reporting 的 ctx 引擎（D12：执行时基于唯一事实源动态计算）。

const fs = require('fs');
const path = require('path');

const WANTED = [["Context Summary", "context-summary.md", false], ["Alignment Spec", "spec.md", false], ["Plan", "plan.md", false], ["Test Plan", "test-plan.md", false], ["验证日志", "verification.log", false]];
