'use strict';
// delivery-doc 的 ctx 引擎（D12：执行时基于唯一事实源动态计算）。

const fs = require('fs');
const path = require('path');

const WANTED = [["Alignment Spec", "spec.md", true], ["Plan", "plan.md", true], ["Test Plan", "test-plan.md", false], ["验证日志", "verification.log", false]];
